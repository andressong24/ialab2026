...
- The scaffold has no authentication, persistence, bank connections, receipt scanning, AI, or export services. Keep sample financial data explicit and local. Do not present a placeholder operation as successful processing or storage.
